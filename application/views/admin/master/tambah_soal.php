					...
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/simpan_soal');?>" method="post" enctype='multipart/form-data'>
						...
						<div class="form-body">
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="1" placeholder="Type something" required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="2" placeholder="Type something" required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="3" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="4" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="5" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>

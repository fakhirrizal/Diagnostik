...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#kategori_soal").change(function(){
			var value=$(this).val();
			$.ajax({
				data:{id:value,modul:'get_form_soal_by_kategori'},
				success: function(respond){
					$("#show_soal").html(respond);
				}
			})
		});
...
<div class="page-content-inner">
	<div class="m-heading-1 border-yellow m-bordered" style="background-color:#FAD405;">
		...
		<p> 3. Untuk soal dengan kategori <b>Matching</b> jawaban bisa lebih dari soal guna keperluan acak jawaban.</p>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/simpan_soal');?>" method="post" enctype='multipart/form-data'>
						...
						<div class="form-body">
                            <div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<textarea class="form-control" name="isi" rows='3' placeholder="Type something" required></textarea>
							...
							<hr>
							<div class="form-group form-md-line-input has-danger">
								<label class="col-md-2 control-label" for="form_control_1">Tipe Soal <span class="required"> * </span></label>
								<div class="col-md-10">
									<select class='form-control' id='kategori_soal' name='kategori_soal' required>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="a" placeholder="Type something" required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="b" placeholder="Type something" required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="c" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="d" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="e" placeholder="Type something">
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>

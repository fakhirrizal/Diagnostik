						...
						<div class="row">
							<div class="col-md-8">
								<div class="btn-group">
									...
									<a href="<?=base_url('admin_side/tambah_modul_ujian');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('admin/Master/json_modul_ujian'); ?>"
								},
								"aoColumns": [
											...
											{ mData: 'durasi', sClass: "alignCenter" },
